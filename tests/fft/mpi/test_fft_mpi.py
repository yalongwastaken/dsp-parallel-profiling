...
# validates fft_mpi output against fft_baseline across process counts and input types
# note: fft_mpi is a segmented fft — each rank processes n/nprocs samples independently,
...
def run_baseline_chunks(bin_path, n, nprocs):
    ...
    """
    # read samples back from binary to split into chunks

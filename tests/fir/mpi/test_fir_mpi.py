...
# validates fir_mpi output against fir_baseline across process counts and input types
# fir_mpi scatters input with overlap so each rank can compute boundary samples correctly;
# the full output is compared against a single baseline run on the complete signal

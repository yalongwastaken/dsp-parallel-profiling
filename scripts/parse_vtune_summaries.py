# file:        parse_vtune_summaries.py
# author:      Vaidehi Gohil, Anthony Yalong
# description: parses all vtune summary txt files in a directory into a single csv.
#              filename format expected: fft_pthreads_t8_n67108864_summary.txt
# usage:       python3 scripts/parse_vtune_summaries.py <vtune_dir> <output_csv>
